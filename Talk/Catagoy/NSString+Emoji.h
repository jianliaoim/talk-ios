...
/**
 *  get first word With emoji for string
 *
 *  @param inputString string
 *
 *  @return first word for string
 */
+ (NSString *)getFirstWordWithEmojiForString:(NSString *)inputString;
@end
