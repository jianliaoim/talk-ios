...
- (UIView *)hudView {
    if(!_hudView) {
        if (iOS8)
        {
            _hudView = [[UIVisualEffectView alloc] initWithEffect:[UIBlurEffect effectWithStyle:UIBlurEffectStyleExtraLight]];
        }
       else
        {
            _hudView = [[UIView alloc]init];
            _hudView.backgroundColor = [UIColor colorWithWhite:0.9 alpha:0.9];
        }
        _hudView.frame = CGRectZero;
